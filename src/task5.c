...
// #define __task5_runtime_copy(group) __attribute__((used, section(".task5_runtime_copy." group)))
...
// */
// static __scratch_y("task5") data_in_t data_in = {
//     .x = 8,
...
//     };
// static __scratch_y("task5") data_out_t data_out;

// /*
//     Place the attribute to note that this is an exec function
// */
// void __task5_runtime_copy("task5")(task5_E)(local_data_t * local_data)
// {
...
// */
// void task5(subschedule_t subschedule) //add relative waiting times as a parameter here
// {
//     #ifdef DEBUG
...
//     extern char __task5_runtime_copy_start__[],  __task5_runtime_copy_end__[];
...
//     int func_size = (int) (__task5_runtime_copy_end__) - (int)(__task5_runtime_copy_start__);
...
//     exec_copy_func = (memcpy(subschedule.exec_copy_func_dst, __task5_runtime_copy_start__, func_size) + 1); // note the +1 because the return address is even but the function must execue from an odd address (little endian)
